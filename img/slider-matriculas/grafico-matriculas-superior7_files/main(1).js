...
function pageLoaded() 
{
	...
	console.log("Reporting label: (" + dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].Reporting_Label + ")");
	console.log("Exit url: (" + dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].Exit_URL.Url + dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].Sub_ID + ")");

    //Load in CSS
    var extCSS = document.createElement("link");
    extCSS.setAttribute("rel", "stylesheet");
    extCSS.setAttribute("type", "text/css");
    extCSS.setAttribute("href", dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].CSS_Name);
    document.head.appendChild(extCSS);

    var script = document.createElement('script');
	script.type = 'text/javascript';
	script.src = dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].JS_Name;    
...
function initApp()
{
	...
	$("#buttonLabel").innerHTML = dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].CTA_Text; // CTA_Text
	
	$("#SmallButtonLabel").innerHTML = dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].CTA_Text; // Smaller_CTA_Text
	...
	TweenLite.to($("#PreCtaRectangle"), 0, {backgroundColor:bgEndColor});
...
{
	var tempString = "";
	bgEndColor = dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].BG_Color; // BG_Color
	introCopy2Start = parseFloat(dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].Start_Time_Text_2); // Start_Time_Text_2
	wipeStart = parseFloat(dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].Start_Time_Wipe); // Start_Time_Wipe

	parseFontSizes()

	// Grab dynamic copy text & place into array holders
	tempString  = dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].text_1; // Text_1_Line_1
	copyBatch1 = tempString.split("|");
	tempString  = dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].text_2; // Text_1_Line_1
	copyBatch2 = tempString.split("|");
	tempString  = dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].text_3; // Text_1_Line_1
...
function parseFontSizes()
{
	...
	if (dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].fontsize && dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].fontsize != "")
	{
		tempString = dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].fontsize;
...
{
	Enabler.exitOverride("CTA Exit", dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].Exit_URL.Url + dynamicContent.Q315_Google_Tangram_Feed_Brazil_Feed[0].Sub_ID);
}
